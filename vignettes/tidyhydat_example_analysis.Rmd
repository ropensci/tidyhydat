...
##  4 01AD003        H         <NA>               2011    2024            14
##  5 01AD003        Q         <NA>               1951    2024            74
...
```
## Error in `dplyr::bind_rows()` at ]8;line = 98:col = 3;file:///Users/sam.albers/_dev/gh_repos/tidyhydat/R/utils-realtime.Rtidyhydat/R/utils-realtime.R:98:3]8;;:
## ! Can't combine `..1$Date` <logical> and `..2$Date` <datetime<UTC>>.
```
...
```
## Error:
## ! object 'nunavut_realtime' not found
```
