...
```
##   Queried from version of HYDAT released on 2023-01-15
##    Observations:                      31,351
...
```
## [1] "01CA003" "01CB002" "01CB004" "01CB018" "01CC002" "01CC005" "01CC010"
## [8] "01CC011" "01CD005"
```
...
```
## # A tibble: 9 × 5
##   STATION_NUMBER STATION_NAME                      PROV_TERR_S…¹ LATIT…² LONGI…³
##   <chr>          <chr>                             <chr>           <dbl>   <dbl>
...
## # … with abbreviated variable names ¹​PROV_TERR_STATE_LOC, ²​LATITUDE, ³​LONGITUDE
```
...
```
## # A tibble: 54 × 5
##    STATION_NUMBER STATION_NAME                           PROV_…¹ LATIT…² LONGI…³
##    <chr>          <chr>                                  <chr>     <dbl>   <dbl>
...
##  7 08MF072        FRASER RIVER AT LAIDLAW                BC         49.3   -122.
##  8 08MF075        FRASER RIVER AT LOWER KENT             BC         49.2   -122.
##  9 08MF076        FRASER RIVER ABOVE HUNTER CREEK        BC         49.4   -122.
## 10 08MF001        ANDERSON RIVER NEAR BOSTON BAR         BC         49.8   -121.
## # … with 44 more rows, and abbreviated variable names ¹​PROV_TERR_STATE_LOC,
## #   ²​LATITUDE, ³​LONGITUDE
```
...
![plot of chunk unnamed-chunk-9](vignette-fig-unnamed-chunk-9-1.png)
