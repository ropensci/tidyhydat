...
SED_SAMPLES <- function(hydat_path=NULL, STATION_NUMBER = NULL, PROV_TERR_STATE_LOC = NULL, start_date ="ALL", end_date = "ALL") {
  ...
  sed_samples = dplyr::left_join(sed_samples, dplyr::tbl(hydat_con, "SED_VERTICAL_LOCATION"), 
  ...
  sed_samples = select(sed_samples, STATION_NUMBER, SED_DATA_TYPE_EN, DATE, SAMPLE_REMARK_EN, TIME_SYMBOL,
