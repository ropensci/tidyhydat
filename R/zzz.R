...
.onLoad <- function(libname = find.package("tidyhydat"), pkgname = "tidyhydat") {
  ...
  if (getRversion() >= "2.15.1")
    utils::globalVariables( # Vars used in Non-Standard Evaluations, declare here to avoid CRAN warnings
      ## This is getting ridiculous
      c(
        "PROV_TERR_STATE_LOC", "FULL_MONTH", "MAX", "DAY", "FLOW", "MONTH",
        ...
        "SV_DEPTH2", "TEMPERATURE", "TIME_SYMBOL", "YEAR_FROM", "YEAR_TO", "condensed_date","temp2","SYMBOL_FR",
        "SUSCON_SYMBOL",
