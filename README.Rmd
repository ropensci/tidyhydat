...
- Provides functions (`available_*`) that seamlessly combine validated historical data with provisional real-time data.
...
For a complete record combining validated historical data with recent provisional data:
