...
test_that("SED_DLY_SUSCON respects Date specification", {
  ...
  temp_df <- SED_DLY_SUSCON(STATION_NUMBER = "08MH024", hydat_path = "H:/Hydat.sqlite3",
...
test_that("SED_DLY_SUSCON correctly parses leaps year",{
  expect_warning(SED_DLY_SUSCON(PROV_TERR_STATE_LOC = "BC", hydat_path = "H:/Hydat.sqlite3",
