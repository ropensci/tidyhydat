...
test_that("hy_stn_remarks returns a dataframe", {
  expect_is(hy_stn_remarks(STATION_NUMBER = "08MF005", 
...
test_that("hy_stn_datum_conv returns a dataframe", {
  expect_is(hy_stn_datum_conv(STATION_NUMBER = "08MF005", 
                                 hydat_path = system.file("test_db/tinyhydat.sqlite3", package = "tidyhydat")), class = "tbl_df")
})
...
test_that("hy_stn_data_range returns a dataframe", {
  expect_is(hy_stn_data_range(STATION_NUMBER = "08MF005", 
                           hydat_path = system.file("test_db/tinyhydat.sqlite3", package = "tidyhydat")), class = "tbl_df")
})

test_that("hy_stn_data_coll returns a dataframe", {
  expect_is(hy_stn_data_coll(STATION_NUMBER = "08MF005", 
                                hydat_path = system.file("test_db/tinyhydat.sqlite3", package = "tidyhydat")), class = "tbl_df")
})

test_that("hy_stn_op_schedule returns a dataframe", {
  expect_is(hy_stn_op_schedule(STATION_NUMBER = "08MF005", 
                                   hydat_path = system.file("test_db/tinyhydat.sqlite3", package = "tidyhydat")), class = "tbl_df")
})
