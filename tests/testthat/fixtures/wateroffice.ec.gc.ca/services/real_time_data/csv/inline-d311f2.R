structure(list(method = "GET", url = "https://wateroffice.ec.gc.ca/services/real_time_data/csv/inline?stations[]=08MF005&parameters[]=46&start_date=2025-01-01%2000:00:00&end_date=2025-01-02%2023:59:59",
    status_code = 200L, headers = structure(list(Date = "Mon, 01 Jan 2025 12:00:00 GMT",
